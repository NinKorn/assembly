<template>
    <div class="img-canvas">
        ...
        <el-dialog :visible.sync="dialogVisible">
            <div
                v-if="type==='image/png'||type==='image/gif'||type==='image/jpeg'"
            >
                <img width="100%" :src="dialogImageUrl" alt />
            </div>
            <div v-else-if="type==='application/pdf'" class="pdf">
                    ...
                    if (this.position == 'rightBottom') {
                        ctx.translate(
                            img.width -
                                ...
                                this.leftX,
                            img.height - 10 - this.topY
                        )
                    } else if (this.position == 'center') {
                        ctx.translate(
                            img.width / 2 + this.leftX,
                            img.height / 2 + this.topY
                        )
                    } else if (this.position == 'leftTop') {
                        ctx.translate(
                            this.leftX + ctx.measureText(this.text).width / 2,
                            this.topY + 20
                        )
                    }
